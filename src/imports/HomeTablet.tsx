...
function TabletHeader() {
  return (
    <div className="bg-white box-border content-stretch flex items-center justify-end overflow-clip px-[50px] py-[45px] relative shrink-0 w-[834px]" data-name="tablet_header">
      <Hamburgermenu />
    </div>
  );
}
...
function LogoFrame() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-start left-[50px] top-[375px] w-[500px]" data-name="logo_frame">
      <div className="aspect-[957/183] basis-0 grow min-h-px min-w-px relative shrink-0" data-name="sept3_corporate_logo_img">
...
function TextFrame() {
  return (
    <div className="absolute content-stretch flex gap-[10px] items-center justify-center left-[50px] top-[525px]" data-name="text_frame1">
...
function Main() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[988px] overflow-clip relative shrink-0 w-[834px]" data-name="main1">
      <div className="absolute h-[981px] left-[calc(50%+-0.075px)] top-[6px] translate-x-[-50%] w-[833.85px]" data-name="sept3_typography_img">
...
function HomeFrame() {
  return (
    <div className="box-border content-stretch flex gap-[10px] h-[1077px] items-start justify-center p-[50px] relative shrink-0 w-[834px]" data-name="home_frame">
      <Main />
    </div>
  );
}
...
function MainFrame() {
  return (
    <div className="h-[310px] relative shrink-0 w-[723px]" data-name="main_frame2">
      <TextFrame2 />
      <TextFrame1 />
    </div>
  );
...
function AboutFrame() {
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col gap-[50px] h-[410px] items-start overflow-clip p-[50px] relative shrink-0 w-[834px]" data-name="about_frame">
      <MainFrame />
    </div>
  );
}
...
function TextFrame5() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-[110px]" data-name="text_frame5-1">
...
function TextFrame6() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-[576px]" data-name="text_frame5-2">
      <div className="font-['Zen_Kaku_Gothic_Antique:Regular',sans-serif] leading-[40px] not-italic relative shrink-0 text-[18px] text-black w-[576px]">
...
function TextFrame4() {
  return (
    <div className="content-stretch flex gap-[50px] items-start relative shrink-0 w-[110px]" data-name="text_frame5">
      <TextFrame5 />
      <TextFrame6 />
    </div>
  );
...
function CompanyFrame() {
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col gap-[50px] h-[535px] items-start overflow-clip p-[50px] relative shrink-0 w-[834px]" data-name="company_frame">
      <TextFrame3 />
      <TextFrame4 />
    </div>
  );
...
function Frame() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[80px] h-[2437px] items-center left-0 top-[200px] w-[834px]">
      <HomeFrame />
      <AboutFrame />
      <CompanyFrame />
      <FooterFrame />
...
function Frame1() {
  return (
    <div className="h-[2637px] relative shrink-0 w-[834px]">
      <Frame />
    </div>
  );
}
...
export default function HomeTablet() {
  return (
    <div className="bg-white content-stretch flex flex-col gap-[80px] items-center relative size-full" data-name="home_tablet">
      <TabletHeader />
      <Frame1 />
    </div>
  );
