...
function MainFrame4() {
  return (
    <div className="absolute bg-[rgba(255,255,255,0)] box-border content-stretch flex gap-[10px] h-[300px] items-start justify-center left-1/2 overflow-clip px-[25px] py-0 top-[60px] translate-x-[-50%] w-[393px]" data-name="main_frame1-2">
      <div className="h-[300px] relative shrink-0 w-[343px]" data-name="sept3_typography_img">
...
function TextFrame() {
  return (
    <div className="content-stretch flex gap-[10px] items-start overflow-clip relative shrink-0" data-name="text_frame1">
      <p className="font-['Zen_Kaku_Gothic_Antique:Regular',sans-serif] leading-[59px] not-italic relative shrink-0 text-[26px] text-black text-nowrap tracking-[13px] whitespace-pre">PHILOSOPHY</p>
    </div>
  );
}
...
function MainFrame3() {
  return (
    <div className="absolute box-border content-stretch flex items-start left-1/2 px-[25px] py-0 top-0 translate-x-[-50%] w-[393px]" data-name="main_frame1-1">
      <TextFrame />
    </div>
  );
}
...
function PhilosophyFrame() {
  return (
    <div className="h-[360px] relative shrink-0 w-[393px]" data-name="philosophy_frame">
      <MainFrame4 />
      <MainFrame3 />
    </div>
  );
...
function TextFrame1() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="text_frame2">
...
function MainFrame() {
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col h-[420px] items-start overflow-clip px-[25px] py-0 relative shrink-0 w-[393px]" data-name="main_frame2">
      <TextFrame1 />
    </div>
  );
}
...
function Sept3ResponseTextFrame2() {
  return (
    <div className="[grid-area:1_/_1_/_auto_/_auto] box-border content-stretch flex gap-[7.634px] items-center justify-center ml-[1.527px] mt-[38.931px] relative" data-name="sept3_response_text_frame2">
      <div className="font-['Zen_Old_Mincho:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap whitespace-pre">
...
function Sept3ResponseTextFrame1() {
  return (
    <div className="[grid-area:1_/_1_/_auto_/_auto] box-border content-stretch flex gap-[7.634px] items-center justify-center ml-0 mt-0 relative" data-name="sept3_response_text_frame1">
      <p className="font-['Zen_Old_Mincho:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c20000] text-[21px] text-nowrap whitespace-pre">心を慥かめる</p>
    </div>
  );
}
...
function Sept3ResponseTextFrame() {
  return (
    <div className="absolute box-border content-stretch flex gap-[19.084px] items-start left-[17.56px] px-0 py-[3.817px] top-[132.5px]" data-name="sept3_response_text_frame">
      <Sept3ResponseText />
    </div>
  );
}
...
function Sept3ResponseFrame() {
  return (
    <div className="absolute h-[240px] left-1/2 top-0 translate-x-[-50%] w-[235px]" data-name="sept3_response_frame">
      <div className="absolute left-[60px] size-[114.504px] top-[13px]" data-name="sept3_response_img">
...
function Sept3FeelingText2() {
  return (
    <div className="[grid-area:1_/_1_/_auto_/_auto] box-border content-stretch flex gap-[7.634px] items-center justify-center ml-[1.527px] mt-[38.931px] relative" data-name="sept3_feeling_text2">
      <div className="font-['Zen_Old_Mincho:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap whitespace-pre">
...
function Sept3FeelingText1() {
  return (
    <div className="[grid-area:1_/_1_/_auto_/_auto] box-border content-stretch flex gap-[7.634px] items-center justify-center ml-0 mt-0 relative" data-name="sept3_feeling_text1">
      <p className="font-['Zen_Old_Mincho:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c20000] text-[21px] text-nowrap whitespace-pre">心を掻き乱す</p>
    </div>
  );
}
...
function Sept3FeelingTextFrame() {
  return (
    <div className="absolute box-border content-stretch flex gap-[19.084px] items-start left-[17.56px] px-0 py-[3.817px] top-[132.5px]" data-name="sept3_feeling_text_frame">
      <Sept3FeelingText />
    </div>
  );
}
...
function Sept3FeelingFrame() {
  return (
    <div className="absolute h-[240px] left-1/2 top-[255px] translate-x-[-50%] w-[235px]" data-name="sept3_feeling_frame">
      <div className="absolute left-[60px] size-[114.504px] top-[13px]" data-name="sept3_feeling_img">
...
function Sept3ThoughtsTextFrame2() {
  return (
    <div className="[grid-area:1_/_1_/_auto_/_auto] box-border content-stretch flex gap-[7.634px] items-center justify-center ml-[1.527px] mt-[38.931px] relative" data-name="sept3_thoughts_text_frame2">
      <div className="font-['Zen_Old_Mincho:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-nowrap whitespace-pre">
...
function Sept3ThoughtsTextFrame1() {
  return (
    <div className="[grid-area:1_/_1_/_auto_/_auto] box-border content-stretch flex gap-[7.634px] items-center justify-center ml-0 mt-0 relative" data-name="sept3_thoughts_text_frame1">
      <p className="font-['Zen_Old_Mincho:Medium',sans-serif] leading-[normal] not-italic relative shrink-0 text-[#c20000] text-[21px] text-nowrap whitespace-pre">心を捉える</p>
    </div>
  );
}
...
function Sept3ThoughtsTextFrame() {
  return (
    <div className="absolute box-border content-stretch flex gap-[19.084px] items-start left-[17.56px] px-0 py-[3.817px] top-[132.5px]" data-name="sept3_thoughts_text_frame">
      <Sept3ThoughtsText />
    </div>
  );
}
...
function Sept3ThoughtsFrame() {
  return (
    <div className="absolute h-[240px] left-1/2 top-[510px] translate-x-[-50%] w-[235px]" data-name="sept3_thoughts_frame">
      <div className="absolute left-[55px] size-[114.504px] top-[13px]" data-name="sept3_thoughts_img">
...
function MainFrame1() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[759px] overflow-clip relative shrink-0 w-[393px]" data-name="main_frame3">
      <Sept3ResponseFrame />
      <Sept3FeelingFrame />
      <Sept3ThoughtsFrame />
    </div>
...
function Main1Sept3Face() {
  return (
    <div className="absolute content-stretch flex h-[266.094px] items-start justify-center left-1/2 top-[-24.29px] translate-x-[-50%]" data-name="main1_sept3_face">
      <div className="flex items-center justify-center relative shrink-0">
        <div className="flex-none scale-y-[-100%]">
          <div className="h-[308.786px] relative w-[393px]" data-name="sept3_face_img">
...
function MainFrame2() {
  return (
    <div className="bg-[rgba(255,255,255,0)] h-[227.613px] overflow-clip relative w-[393px]" data-name="main_frame4">
      <Main1Sept3Face />
    </div>
  );
}
...
function MainFrame5() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0" data-name="main_frame3-1">
      <p className="font-['Zen_Kaku_Gothic_Antique:Regular',sans-serif] leading-[40px] not-italic relative shrink-0 text-[26px] text-black text-nowrap tracking-[13px] whitespace-pre">WORKS</p>
    </div>
  );
}
...
function MainFrame6() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-full" data-name="main_frame3-2">
      <div className="font-['Zen_Kaku_Gothic_Antique:Regular',sans-serif] leading-[35px] not-italic relative shrink-0 text-[16px] text-black w-[343px]">
...
function MainFrame8() {
  return (
    <div className="content-stretch flex gap-[10px] h-[740px] items-start relative shrink-0 w-[100px]" data-name="main_frame3-3-1">
      <div className="font-['Zen_Kaku_Gothic_Antique:Regular',sans-serif] h-[740px] leading-[35px] not-italic relative shrink-0 text-[16px] text-black w-[100px]">
        <p className="mb-0">ADVERTISING</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">BROCHURES</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">&nbsp;</p>
        <p className="mb-0">&nbsp;</p>
...
function MainFrame9() {
  return (
    <div className="content-stretch flex gap-[10px] h-[740px] items-start relative shrink-0" data-name="main_frame3-3-2">
      <div className="font-['Zen_Kaku_Gothic_Antique:Regular',sans-serif] h-[740px] leading-[35px] not-italic relative shrink-0 text-[16px] text-black w-[218px]">
        ...
        <p className="mb-0">インバウンド向けツール</p>
...
function MainFrame7() {
  return (
    <div className="content-stretch flex gap-[20px] h-[740px] items-start relative shrink-0 w-full" data-name="main_frame3-3">
      <MainFrame8 />
      <MainFrame9 />
    </div>
  );
...
function WorksFrame() {
  return (
    <div className="bg-[rgba(255,255,255,0)] box-border content-stretch flex flex-col gap-[25px] h-[997px] items-start overflow-clip p-[25px] relative shrink-0 w-[393px]" data-name="works_frame">
      <MainFrame5 />
      <MainFrame6 />
      <MainFrame7 />
    </div>
...
function FooterFrame() {
  return (
    <div className="bg-[#f9f9f9] box-border content-stretch flex flex-col gap-[15px] h-[212px] items-center overflow-clip px-[25px] py-[15px] relative shrink-0 w-[393px]" data-name="footer_frame">
      <Footer />
      <FooterText />
    </div>
  );
...
function WorksMobile() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[75px] h-[3411px] items-center overflow-clip px-0 py-[60px] relative shrink-0" data-name="works_ mobile">
      <PhilosophyFrame />
      <MainFrame />
      <MainFrame1 />
      <div className="flex items-center justify-center relative shrink-0">
...
export default function WorksMobile1() {
  return (
    <div className="bg-white content-stretch flex flex-col items-center relative size-full" data-name="works_mobile">
      <MobileHeader />
      <WorksMobile />
    </div>
  );
